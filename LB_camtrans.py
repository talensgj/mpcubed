...
for ind in range(nbins):
    ...
    m[staridx], z[camtransidx], niter[ind], chisq[ind], npoints[ind], npars[ind] = systematics_dev.trans(staruni, camtransuni, mag - sol, emag, verbose=True, use_weights=False)
        
with h5py.File('/data2/talens/3mEast/LBtests/camip_test_iter1.hdf5') as f:
