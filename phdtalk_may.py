...
ax = plt.subplot(gs[1])
plt.plot(jdmid - jdref, mag - clouds, '.', c='k', alpha=.5)
plt.plot(jdmid - jdref, vmag + trans + ipx, c=(146./255,0,0), lw=2)
ax.invert_yaxis()
plt.xlabel('Time [JD - {:.0f}]'.format(jdref))
plt.ylabel('Magnitude')
...
ax = plt.subplot(gs[1])
plt.plot(jdmid - jdref, mag - trans - ipx, '.', c='k', alpha=.5)
plt.plot(jdmid - jdref, vmag + clouds, c=(146./255,0,0), lw=2)
ax.invert_yaxis()
plt.xlabel('Time [JD - {:.0f}]'.format(jdref))
plt.ylabel('Magnitude')
...
ax = plt.subplot(gs[1, 0])
plt.plot(lst, mag - trend1, '.', c='k', alpha=.5)
plt.plot(x2, y2, c=(146./255,0,0), lw=2)
ax.invert_yaxis()
plt.xlabel('Time [LST]')
plt.ylabel('Magnitude')
...
ax = plt.subplot(gs[1, 1])
plt.plot(jdmid - jdref, mag - trend2, '.', c='k', alpha=.5)
plt.plot(x1 - jdref, y1, c=(146./255,0,0), lw=2)
ax.invert_yaxis()
plt.xlabel('Time [JD - {:.0f}]'.format(jdref))
plt.ylabel('Magnitude')
